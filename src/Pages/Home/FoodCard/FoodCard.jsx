    ...
    return (
        <div className="relative bg-white rounded border border-gray-200 overflow-hidden">
            ...
            <div className='flex items-center mx-5 mb-3'>
                <button className='text-sm text-[#51A2FF] font-medium border border-[#51A2FF] hover:bg-[#51A2FF] hover:text-white rounded-full w-full py-2 px-4'>Add to card</button>
            </div>
            {/* discount badge */}
